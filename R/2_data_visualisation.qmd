...
# Aucune données manquante. Attention, en pivotant les données (ou en les modifiant légèrement), on peut faire disparaître des données manquante
```
...
matplot(wavelength, B_w, type = "l", lty = 1) # affichage des différentes
lines(wavelength, snv_x[1,], type = "l", col = "blue")
lines(wavelength, spl, col = "red") 
